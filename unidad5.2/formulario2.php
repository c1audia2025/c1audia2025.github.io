...
$respuestas_correctas = [
    'pregunta1' => [
        'correcta' => 'capa_logica',
        'explicacion' => [
            'capa_logica' => 'Correcto: El software de E/S es la capa lógica que gestiona la comunicación entre el sistema operativo y los dispositivos físicos.',
            'hardware' => 'Incorrecto: El hardware son los dispositivos físicos, no el software.',
            'usuario' => 'Incorrecto: La capa de usuario no gestiona directamente la comunicación con dispositivos físicos.',
            'controlador' => 'Incorrecto: El controlador es parte del sistema operativo, no el software de E/S completo.'
        ]
    ],
    'pregunta2' => [
        'correcta' => 'independencia',
        'explicacion' => [
            'independencia' => 'Correcto: El software busca independencia del dispositivo, manejo de errores y rendimiento.',
            'velocidad' => 'Incorrecto: Aunque importante, la velocidad no es el único objetivo clave.',
            'seguridad' => 'Incorrecto: La seguridad es importante pero no se menciona como objetivo clave aquí.',
            'interfaz' => 'Incorrecto: La interfaz es un medio, no el objetivo principal.'
        ]
    ],
    'pregunta3' => [
        'correcta' => 'cpu_verifica_estado',
        'explicacion' => [
            'cpu_verifica_estado' => 'Correcto: La E/S programada hace que la CPU verifique constantemente el estado del dispositivo.',
            'cpu_libre' => 'Incorrecto: En polling, la CPU no está libre, está ocupada.',
            'interruptor' => 'Incorrecto: Esto no describe la E/S programada.',
            'dma' => 'Incorrecto: DMA es otro método distinto a la programada.'
        ]
    ],
    'pregunta4' => [
        'correcta' => 'libera_cpu',
        'explicacion' => [
            'libera_cpu' => 'Correcto: La E/S por interrupciones libera la CPU para otras tareas.',
            'bloquea_cpu' => 'Incorrecto: Bloquear la CPU es característico del polling, no de interrupciones.',
            'espera_activa' => 'Incorrecto: La espera activa es propia del polling.',
            'espera_pasiva' => 'Incorrecto: La espera pasiva no describe el comportamiento de interrupciones.'
        ]
    ],
    'pregunta5' => [
        'correcta' => 'transferencias_directas',
        'explicacion' => [
            'transferencias_directas' => 'Correcto: DMA permite transferencias directas con mínima intervención de la CPU.',
            'cpu_constante' => 'Incorrecto: DMA minimiza la intervención de la CPU.',
            'dispositivos_lentos' => 'Incorrecto: DMA es ideal para operaciones masivas, no lentas.',
            'procesamiento_datos' => 'Incorrecto: DMA es un mecanismo de transferencia, no procesamiento.'
        ]
    ],
    'pregunta6' => [
        'correcta' => 'teclado_interrupcion',
        'explicacion' => [
            'teclado_interrupcion' => 'Correcto: El teclado genera interrupciones al presionar teclas.',
            'disco_polling' => 'Incorrecto: Los discos suelen usar DMA o interrupciones, no polling constante.',
            'gpu_dma' => 'Incorrecto: GPU usa DMA para transferencias, no interrupciones simples.',
            'impresora_salida' => 'Incorrecto: No es un ejemplo de interrupciones para E/S.'
        ]
    ],
    'pregunta7' => [
        'correcta' => 'configura_gestiona_notifica',
        'explicacion' => [
            'configura_gestiona_notifica' => 'Correcto: El proceso DMA incluye configurar, gestionar y notificar.',
            'solo_configura' => 'Incorrecto: No es solo configurar.',
            'solo_gestiona' => 'Incorrecto: El controlador DMA gestiona, pero la CPU también participa.',
            'solo_notifica' => 'Incorrecto: La notificación es la última etapa.'
        ]
    ],
    'pregunta8' => [
        'correcta' => 'interfaces_uniformes',
        'explicacion' => [
            'interfaces_uniformes' => 'Correcto: La independencia significa usar interfaces uniformes sin importar hardware.',
            'hardware_especifico' => 'Incorrecto: Es lo contrario a la independencia.',
            'software_parecido' => 'Incorrecto: No define independencia del dispositivo.',
            'mismo_codigo' => 'Incorrecto: Es una ventaja, pero no define la independencia.'
        ]
    ],
    'pregunta9' => [
        'correcta' => 'cpu_bloqueada',
        'explicacion' => [
            'cpu_bloqueada' => 'Correcto: El principal problema del polling es que la CPU queda bloqueada esperando.',
            'cpu_libre' => 'Incorrecto: En polling la CPU no está libre.',
            'latencia_baja' => 'Incorrecto: Polling no garantiza baja latencia.',
            'transferencia_directa' => 'Incorrecto: Esto describe DMA.'
        ]
    ],
    'pregunta10' => [
        'correcta' => 'reduce_carga',
        'explicacion' => [
            'reduce_carga' => 'Correcto: DMA reduce la carga de la CPU y permite transferencias rápidas.',
            'incrementa_carga' => 'Incorrecto: DMA disminuye la carga, no la incrementa.',
            'usa_cpu_directa' => 'Incorrecto: DMA evita uso directo constante de la CPU.',
            'solo_para_pequenos' => 'Incorrecto: DMA se usa en dispositivos de alto rendimiento.'
        ]
    ]
];
